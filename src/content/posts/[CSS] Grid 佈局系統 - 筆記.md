...
如果只定義了一個column：  
![ExportedContentImage_04](/images/ryr9FZK0ke.png)

如果`grid-auto-flow: column`：  
![ExportedContentImage_05](/images/SyLl5bKC1l.png)

只定義了兩個row，當兩行擺滿時，新增一個item，就會自動新增一個column：  
![ExportedContentImage_06 (1)](/images/BJWUqWK0Jg.png)

如果只定義一個row，就會產生類似一行的排列效果：  
![ExportedContentImage_07](/images/r1Y9qZKA1x.png)
...
直接看範例：  
![ExportedContentImage_02](/images/SJy6iWFCkg.png)  
HTML:
```html
<div class="container">
  <div class="hen"></div>
